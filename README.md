...
3. Красиво форматирует и выводит информацию о созданном пауке на экран.
...
*(Демонстрация вывода первого паука из исходника и ручного ввода пользовательского паука)*
